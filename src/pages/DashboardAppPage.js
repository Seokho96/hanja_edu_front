      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="학년" total={'5학년'} color="error" icon={'grade'} />
          </Grid>

          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="이름" total={'김철수'} color="info" icon={'name'} />
          </Grid>

          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="급수" total={'2급'} color="warning" icon={'level'} />
          </Grid>
